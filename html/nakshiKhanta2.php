...
<link rel="stylesheet" type="text/css" href="../css/nakshiKhanta.css">
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#results").load("../php/fetch_pages_nk.php");  //initial page number to load
        $(".pagination").bootpag({
        ...
        maxVisible: 5 
            ...
            $("#results").load("../php/fetch_pages_nk.php", {'page':num});
        ...
        function findFiltersAndQuery(num){
            ...
            for(var i = 0; i < order_filter.length; i++){
              if(order_filter[i].checked){
                ...
                $("#results").load("../php/fetch_pages_nk.php", 
				...
				<form class="shop__filter">
					...
					<div class="checkbox">
						<input type="checkbox" name="shop-filter__choice"
							id="shop-filter-choice_1" value=" preference='Women'"> <label
							for="shop-filter-choice_1">Women</label>
					</div>
					<div class="checkbox">
						<input type="checkbox" name="shop-filter__choice"
							id="shop-filter-choice_2" value=" preference='Men'"> <label
							for="shop-filter-choice_2">Men</label>
					</div>
					<div class="checkbox">
						<input type="checkbox" name="shop-filter__choice"
							id="shop-filter-checkbox_3" value=" preference='Other'"
							> <label for="shop-filter-checkbox_3">Other</label>
					</div>
					...
					<div class="shop-filter__color">
						<input type="text" name="shop-filter__color"
							id="shop-filter-color_4" value="AND color='Red'"
							data-input-color="Red"> <label for="shop-filter-color_4"
					...
					<div class="shop-filter__color">
						<input type="text" name="shop-filter__color"
							id="shop-filter-color_6" value="AND color='Pink'"
							data-input-color="Pink"> <label for="shop-filter-color_6"
