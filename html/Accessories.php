...
<body>
    <nav class="navbar navbar-default">
        <div class="container-fluid">
          ...
          <li><a href="..\html\traditionalAttire.php"> Traditional Attire</a></li>
           <li><a href="..\html\nakshiKhanta.php">Nakshi Kantha</a></li>
          <li class='active'><a href="..\html\Accessories.php">Accessories<span class="sr-only">(current)</span></a></li>
        </ul>
  ...
  <div class="row">
    <div class="col-sm-4 col-md-3">
      ...
      <form class="shop__filter">
        ...
        <div class="checkbox">
          <input type="checkbox" value="" id="shop-filter-checkbox_2" checked="">
          <label for="shop-filter-checkbox_2">Other</label>
        </div>
        ...
        <div class="radio">
          <input type="radio" name="shop-filter__radio" id="shop-filter-radio_5" value="" checked="">
